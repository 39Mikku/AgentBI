...
class ChatAgent:
        ...
        for _ in range(4):
            ...
            for call in tool_calls.values():
                ...
                if direct_tool:
                    ...
                    result = await self._invoke_direct_tool(call["name"], call["arguments"])
                    yield {"type": "tool_finished", "tool": direct_tool.display_name, "content": result}
    ...
    async def _invoke_direct_tool(self, name: str, arguments: str) -> str:
