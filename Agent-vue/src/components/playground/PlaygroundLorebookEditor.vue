...
<style scoped>
.editor-section{display:grid;gap:20px;padding:27px;border-top:1px solid var(--pg-line)}.lorebook>header{display:flex;justify-content:space-between;align-items:start;gap:20px}.lorebook header span{color:var(--pg-acid);font:7px var(--font-mono);letter-spacing:.14em}.lorebook h3{margin:8px 0 5px;font-size:18px}.lorebook header p{margin:0;color:var(--pg-muted);font-size:9px}.lorebook header button{border:1px solid var(--pg-acid);background:transparent;color:var(--pg-acid);padding:9px 12px;font:var(--control-font-size) var(--font-mono);cursor:pointer}.entry-list{display:grid;gap:10px}.entry-list article{border:1px solid var(--pg-line);background:#131614}.entry-title{display:grid;grid-template-columns:30px minmax(130px,1fr) 120px auto auto;gap:8px;align-items:center;padding:9px;border-bottom:1px solid var(--pg-line)}.entry-title>b{color:#59615b;font:8px var(--font-mono)}input,select,textarea{box-sizing:border-box;width:100%;border:1px solid var(--pg-line);outline:0;background:#0f1210;color:var(--pg-paper);padding:9px;font:var(--control-font-size) var(--font-sans)}input,select{height:35px}select option{background:#151815}.entry-title>input{border:0;background:transparent;font-weight:700}.entry-title .category{border-left:1px solid var(--pg-line);font-weight:400}.entry-title label{display:flex;gap:5px;color:var(--pg-muted);font:var(--control-font-size) var(--font-mono)}.entry-title label input{width:auto;height:auto;accent-color:var(--pg-acid)}.entry-title button{border:0;background:none;color:#ca7769;font:var(--control-font-size) var(--font-mono);cursor:pointer}.entry-list article>textarea{border:0;resize:vertical}.entry-controls{display:grid;grid-template-columns:120px minmax(150px,1fr) 100px minmax(150px,1fr) 90px;gap:8px;padding:10px;border-top:1px solid var(--pg-line)}.entry-controls label{display:grid;gap:5px}.entry-controls span{color:var(--pg-muted);font:7px var(--font-mono)}.empty{padding:30px;border:1px dashed var(--pg-line);color:#606761;text-align:center;font:8px var(--font-mono)}@media(max-width:900px){.entry-controls{grid-template-columns:repeat(2,1fr)}.entry-title{grid-template-columns:25px 1fr auto auto}.entry-title .category{grid-row:2;grid-column:2/-1}}@media(max-width:600px){.editor-section{padding:20px}.lorebook>header{flex-direction:column}.entry-controls{grid-template-columns:1fr}.entry-title{grid-template-columns:20px 1fr auto}.entry-title label{display:none}.entry-title button{grid-column:3}.entry-title .category{grid-column:2/-1}}
</style>
