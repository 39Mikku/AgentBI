...
<template>
  <main class="test-page">
    <aside class="rail">
      <div class="brand"><i></i><span>AGENTBI</span><b>/ TEST</b></div>
      <AppModeSwitcher active="test" />
      <button class="new-test" @click="newTest"><span>＋</span> NEW TEST</button>
