...
<template>
  <div class="live-shell" :data-phase="live.state.phase">
    <aside class="workspace-rail">
      ...
      <button class="new-conversation" :disabled="live.isActive || !live.currentRole" @click="live.newConversation(userId)">
...
.live-shell { --void:#070a09; --panel:#0d1110; --panel-2:#111715; --mist:#dce8e2; --muted:#6e7974; --signal:#9fffd8; --signal-deep:#28a983; --danger:#ff7668; width:100%; height:100dvh; overflow:hidden; display:grid; grid-template-columns:286px minmax(0,1fr); color:var(--mist); background:var(--void); font-family:Manrope,sans-serif; }
