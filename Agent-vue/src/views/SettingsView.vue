...
.settings header{position:relative}.settings-nav{position:absolute;left:min(760px,70vw);top:0;display:flex;border:1px solid #393939;padding:3px;white-space:nowrap}.settings-nav button{border:0;background:transparent;color:#74716b;padding:8px 14px;font:9px 'DM Mono';letter-spacing:.08em;cursor:pointer}.settings-nav button:hover{color:#eeece6}.settings-nav .active{background:#d9ff36;color:#111}@media(max-width:750px){.settings-nav{left:0;top:42px}.settings .back{margin-bottom:75px}}
</style>
