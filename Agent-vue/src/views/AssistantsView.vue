...
.check small {
  display: block;
  color: #777;
  font: var(--control-font-size)/1.5 'DM Mono';
}
.default-note {
  margin-top: 24px;
  padding: 18px;
...
.save {
  ...
  color: #fff;
  padding: 12px 16px;
  font: 700 var(--control-font-size) Manrope;
  cursor: pointer;
}
.editor fieldset {
  border: 0;
...
.editor .check {
  ...
  background: #f5f3ed;
  color: #1b1b19;
  font: 600 var(--control-font-size) Manrope !important;
